...
local_stopwords = {
  ...
  100080: [ "bobcats", "carolina", "charlotte", "clt", "cltnews", "cltwx", "cmpd", "fox46carolinas", "fox46charlotte", "hill", "marker", "mile", "nascar", "n.c", "nc", "ncpol", "ncsen", "northcarolina", "panthers", "pnc", "power98fm", "sports", "uncc", "wbtv", "wccbcharlotte", "wcnc", "weather", "wpeg", "wncn"],
  ...
  3070: [ "album", "awards", "billboard", "hip", "hiphopdx", "hop", "instagram", "itunes", "itunesmusic", "listen", "music", "official", "premier", "premiers", "rolling", "rollingstone", "song", "songs", "stone", "top", "vevo", "video", "videos", "watch"],
  ...
  100065: [ "celebrity", "photo", "photos", "video", "videos", "web", "yahoo", "yahoonews"],
  100062: [ "sports", "web", "yahoo", "yahoonews"],
  100089: [ "political"] # not done yet
  }
...
if __name__ == '__main__':
  ...
  end_time = int(time.time())-3600*30
